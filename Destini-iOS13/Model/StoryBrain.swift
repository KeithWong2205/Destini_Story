...
struct StoryBrain {
    ...
    func getStoryTitle() -> String {
        return storyArrays[storyNum].title
    }
    
    func getChoice1() -> String{
        return storyArrays[storyNum].choice1
    }
    
    func getChoice2() -> String {
        return storyArrays[storyNum].choice2
    }
    
    mutating func nextStory(userChoice: String) {
        let currentStory = storyArrays[storyNum]
        if(userChoice == currentStory.choice1){
            storyNum = currentStory.choice1Des
        } else {
            storyNum = currentStory.choice2Des
        }
    }
}
